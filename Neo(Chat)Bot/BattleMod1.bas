...
Public Function Encrypt(Text As String) As String
    ...
    x$ = " ?!@#$%^&*()_+|0123456789abcdefghijklmnopqrstuvwxyz.,-~ABCDEFGHIJKLMNOPQRSTUVWXYZø°≤≥¿¡¬√ƒ≈“”‘’÷Ÿ€‹‡·‚„‰Âÿ∂ß⁄•"
    X2$ = " ø°@#$%^&*()_+|9876543210.b¡d-√*h^jk$m#“”]‘t÷+vw|‹z.,-~~'·‚„FRg‰J•Â\/ÿ∂zQRßu⁄V0X•Z?!23acefinoprstuxyBCDEILOPSUY"
    For i% = 1 To Len(Text)
